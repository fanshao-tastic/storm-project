...
public class CoordTransform {
   ...
   private final double ee = 0.00669342162296594323;
     ...
     * @returns {*[]}
     */
    public  Point wgs84tobd09(double lng,double lat){
    	//return  gcj02tobd09(wgs84togcj02(lng,lat).getX(),wgs84togcj02(lng,lat).getY());
    	Point point=null;
    			point=wgs84togcj02(lng,lat);
    			if(point!=null){
    ...
    public boolean out_of_china(double lng,double lat){
    	if(lng > 113.000 && lng < 115.000 && lat > 29.000 && lat < 32.000){
    		return true;
    	}
    	return false;
    }
